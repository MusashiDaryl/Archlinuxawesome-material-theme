...
local globalKeys =
  ...
  awful.key(
   ...
   awful.key(
    ...
    'g',
    function()
      awful.util.spawn(apps.default.chrome)
    end,
  ...
  awful.key(
    ...
    'j',
    function()
      awful.util.spawn(apps.default.jeux)
    end,
  ...
  awful.key(
    ...
    'p',
    function()
      awful.util.spawn(apps.default.pdf)
    end,
    {description = 'open masterpdfeditor', group = 'launcher'}
  ),
  awful.key(
    {modkey},
    'm',
  ...
  awful.key(
    ...
    '$',
    function()
      awful.util.spawn(apps.default.trading)
    end,
    {description = 'open metatrader', group = 'launcher'}
  ),
  awful.key(
    {modkey, altkey},
    'b',
  ...
  awful.key(
    ...
    {description = 'open transmission torrent', group = 'launcher'}
  ),
  awful.key(
    {modkey, altkey},
    'i',
    function()
      awful.util.spawn(apps.default.irc)
    end,
    {description = 'open hexchat', group = 'launcher'}
  ),
  awful.key(
    {modkey},
    'k',
    function()
      awful.util.spawn(apps.default.kodi)
    end,
  ...
  awful.key(
    ...
    's',
    function()
      awful.util.spawn(apps.default.slack)
    end,
  ...
  awful.key(
    ...
    'c',
    function()
      awful.util.spawn(apps.default.math)
    end,
  ...
  awful.key(
    ...
    'v',
    function()
      awful.util.spawn(apps.default.vlc)
    end,
  ...
  awful.key(
    ...
    'd',
    function()
      awful.util.spawn(apps.default.discord)
    end,
  ...
  awful.key(
    ...
    's',
    function()
      awful.util.spawn(apps.default.sound)
    end,
...
for i = 0, 9 do
  ...
  if i == 1 or i == 9 then
    descr_view = {description = ' #', group = 'tag'}
  ...
  globalKeys =
    ...
    awful.key(
      ...
      function()
        if _G.client.focus then
          local tag = _G.client.focus.screen.tags[i+9]
          if tag then
            _G.client.focus:move_to_tag(tag)
          end
        end
